...
struct ThursdayView: View {
        ...
        var body: some View {
            GeometryReader { geometry in
                ZStack {
                    LinearGradient(gradient: Gradient(colors: [.cyan, .black, .green]), startPoint: .topLeading, endPoint: .bottomTrailing)
                    ...
                    ScrollView {
                        VStack(spacing: 20) {
                            ...
                            Text("JUEVES: AERÓBICO & ESTIRAMIENTOS")
                                .font(.title)
                                .fontWeight(.bold)
                                .italic()
                                .underline()
                            ...
                            ExerciseView(exerciseName: "BURPEE", description: """
                                Burpee
